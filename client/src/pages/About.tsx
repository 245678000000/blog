...
const timeline = [
  ...
  },
  {
    ...
    title: "法律硕士 (国际法方向)",
    organization: "上海师范大学",
    description: "专注 AI 与法律交叉：合规自动化、知识库问答、Agent 在法务场景中的边界与责任。",
    icon: GraduationCap,
  },
  {
    year: "2025.11",
    ...
    organization: "项目负责人",
    description: "探索 LLM 在司法行政领域的垂直应用，验证长文本逻辑分析与结构化输出潜力。",
    icon: Award,
  },
  {
    year: "2025",
  ...
  },
  {
    ...
    description: "设计 Agent Workflow 自动化生成链路，针对法条引用幻觉做结构化约束与人工复核节点。",
    icon: Code,
  },
  {
    ...
    description: "数据清洗、深度检索，将非结构化法律文本转化为可检索、可分析的结构化数据。",
    icon: Briefcase,
  },
  {
    ...
    title: "校辩论队队长",
    organization: "逻辑思维训练",
    description: "高强度逻辑拆解训练，构建 Chain-of-Thought 式论证闭环——后来直接迁移到 Agent 设计里。",
    icon: MessageSquare,
  },
  {
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
                  <p>
                    ...
                    <strong className="text-foreground">AI 工程</strong> 拧在一起的开发者。
                  </p>
                  <p>
                    我做{" "}
                    <a
                    ...
                    <strong className="text-foreground">RAG 知识库</strong>、垂直场景{" "}
                    <strong className="text-foreground">Chatbot</strong>，以及能「实现 → 验证 →
                    审查」闭环的 <strong className="text-foreground">Agent Harness</strong>。
                  </p>
                  <p>
                    法学训练给了我对边界、例外与可追责性的敏感度——这恰好是靠谱 Agent
                    最缺的那一层：不只会生成，还知道何时该停、该引用、该让人复核。
                  </p>
                  <p>
                    <em>Idea 能快速变成可演示、可复用、可分发的东西。拒绝空谈。</em>
                  </p>
                </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0 space-y-3">
                      <div className="flex flex-wrap items-center gap-2">
                        <h3 className="text-lg font-serif font-bold">{project.title}</h3>
                        <Badge
                          variant="secondary"
